...
pub async fn serve(args: ServeArgs) -> anyhow::Result<()> {
    ...
    use skm_select::{CascadeSelector, TriggerStrategy};
...
async fn list_skills(registry: Arc<skm_core::SkillRegistry>) -> axum::Json<serde_json::Value> {
...
async fn select_skill(
    selector: Arc<skm_select::CascadeSelector>,
    registry: Arc<skm_core::SkillRegistry>,
